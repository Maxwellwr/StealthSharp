...
namespace StealthSharp.Enumeration
{
    ...
    {
        [EventDataType(typeof(Identity))]
        ItemInfo = 0,
        [EventDataType(typeof(Identity))]
        ItemDeleted = 1,
        [EventDataType(typeof(SpeechEvent))]
        Speech = 2,
        ...
        [EventDataType(typeof(Identity))]
        DrawObject = 10,
        [EventDataType(typeof(MenuEvent))]
        Menu = 11,
        ...
        BuffDebuffSystem = 17,
        [EventDataType(typeof(EmptyEvent))]
        ClientSendResync = 18,
        ...
        IncomingGump = 24,
        // 25-26 Timer
        [EventDataType(typeof(uint))]
        WindowsMessage = 27,
        [EventDataType(typeof(SoundEvent))]
        Sound = 28,
        [EventDataType(typeof(bool))]
        Death = 29,
        [EventDataType(typeof(QuestArrowEvent))]
        QuestArrow = 30,
        [EventDataType(typeof(Identity))]
        PartyInvite = 31,
        [EventDataType(typeof(MapPinEvent))]
        MapPin = 32,
